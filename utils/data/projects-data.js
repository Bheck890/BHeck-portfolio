...
export const projectsData = [
    ...
    {
        id: 4,
        name: 'Predict Laundry State',
        description: 'I have made an application that predicts the best time to go to laundry in a shared Laundry Room. College dorm had an online laundry system that had a json file that showed the machine on or off, I gathered the data and uploaded the 10,000+ json files onto a MySQL Server system, that allowed me to Predict the times that the Machines were on or off.  So, I could do my laundry without anyone there, to do the most laundry. ',
        tools: ['Java FX, SQLite, Gradle'],
        role: 'Software Engineer',
        code: '',
        demo: '',
        image: crefin,
